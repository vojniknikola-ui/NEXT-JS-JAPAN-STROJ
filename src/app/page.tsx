        ...
        <div className="relative z-20 text-center px-4 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
            <button
              ...
              className="group bg-[#ff6b00] hover:bg-[#ff7f1a] text-white px-8 sm:px-10 py-4 sm:py-5 rounded-full font-bold text-base sm:text-lg transition-all duration-300 hover:scale-105 shadow-2xl hover:shadow-[#ff6b00]/50 flex items-center gap-2 sm:gap-3"
            >
            ...
            <button
              ...
              className="group border-2 border-white/80 text-white hover:bg-white hover:text-black px-8 sm:px-10 py-4 sm:py-5 rounded-full font-bold text-base sm:text-lg transition-all duration-300 hover:scale-105 backdrop-blur-sm bg-white/5 flex items-center gap-2 sm:gap-3"
            >
              <svg className="w-5 h-5 sm:w-6 sm:h-6 group-hover:rotate-12 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-2xl font-black text-[#ff6b00]">{part.priceWithVAT.toFixed(2)} BAM</span>
