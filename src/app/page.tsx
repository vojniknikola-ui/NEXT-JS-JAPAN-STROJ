        ...
        <div className="relative z-20 text-center px-4 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button
              ...
              className="group bg-[#ff6b00] hover:bg-[#ff7f1a] text-white px-10 py-5 rounded-full font-bold text-lg transition-all duration-300 hover:scale-105 shadow-2xl hover:shadow-[#ff6b00]/50 flex items-center gap-3"
            >
            ...
            <button
              ...
              className="group border-2 border-white/80 text-white hover:bg-white hover:text-black px-10 py-5 rounded-full font-bold text-lg transition-all duration-300 hover:scale-105 backdrop-blur-sm bg-white/5 flex items-center gap-3"
            >
              <svg className="w-6 h-6 group-hover:rotate-12 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
